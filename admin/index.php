...
<html lang="en">
    ...
    <head>
        ...
        <title>Aplikasi rehabilitasi narkoba</title>
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-sm-8 col-sm-offset-2 text">
                            <h1><strong>Sistem Informasi</strong> Rehabilitasi Narkoba</h1>
                            <div class="description">
                            	<p>
	                            	Aplikasi Web Kolaborasi Masyarakat dan BNNP DIY untuk pelaporan pelaku penyalahgunaan <a href="http://azmind.com"><strong>NARKOBA</strong></a>, guna di rehabilitasi
                            	</p>
                            </div>
                        </div>
                    </div>
